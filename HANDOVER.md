...
最終更新: 2026-05-13（β36 配布中 / β33 撤回 / 開発リポ Public 化済 / CI 案 B-2 適用済） / 現在のバージョン: **v2.0.0-beta.36（β34 で E1 太字独立軸 + E2 外部 PDF viewer vector render、β35 で F1/F2 画質改善、β36 で G1 吹き出し枠ぴったり化 + G2 wrap 維持 commit path 統一）**
