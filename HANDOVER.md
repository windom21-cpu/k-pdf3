...
| 0029 | A4 サイズに切り取り (非 A4 ページに A4 縦固定枠をドラッグ配置 → 枠 1 = 1 ページの別ファイル化。cropFrames 後処理方式で既存組み立て経路は不変) | ✅ 実装済 (feat `cbbecba`)・**v2.0.27-beta.3 で β 配信 (2026-08-24)・実機確認待ち** |
